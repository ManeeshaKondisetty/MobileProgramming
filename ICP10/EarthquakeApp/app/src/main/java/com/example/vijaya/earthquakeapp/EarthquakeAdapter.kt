...
(context: Context?, earthquakes: List<Earthquake?>?) : ArrayAdapter<Earthquake?>(context!!, 0, earthquakes!!) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (originalLocation.contains(LOCATION_SEPARATOR)) {
            ...
            val parts = originalLocation.split(LOCATION_SEPARATOR).toTypedArray()
    ...
    /**
     * Return the formatted date string (i.e. "Mar 3/84") from a Date object.
     */
    private fun formatDate(dateObject: Date): String {
        val dateFormat = SimpleDateFormat("LLL dd/yy")
